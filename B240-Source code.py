# command to run the program and show the output: python3 main.py imshow  #
# command to run the program and save the output: python3 main.py imwrite #
        ...
        #with tf.compat.v1.Session(graph=detection_graph) as sess: # use this line to run it with TensorFlow version 2.x
            ...
            while cap.isOpened():
                ...
                if counter == 1:
                    ...
                    cv2.line(input_frame, (0, 200), (690, 200), (0, 0xFF, 0), 5)
                else:
                    cv2.line(input_frame, (0, 200), (690, 200), (0, 0, 0xFF), 5)
